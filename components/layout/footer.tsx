    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Sunshine Travel Consultancy</h3>
            <p className="text-gray-400 mb-4">
              Connecting skilled Indian professionals with excellent opportunities in Gulf countries.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="text-gray-400">Prince Vishwakarma</p>
                  <p className="text-white">+91 8112384070</p>
                </div>
              </li>
              <li className="flex items-start">
          ...
          {/* Office Locations */}
          <div>
            <h3 className="text-xl font-bold mb-4">Office Locations</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} Sunshine Travel Consultancy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
